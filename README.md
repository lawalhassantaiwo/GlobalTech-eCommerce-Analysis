...
GlobalTech-eCommerce's dataset comprises records from the company's ERP system, organized into five tables: orders, customers, geo_lookup, order_status, and suppliers, totaling 108,130 rows. The analysis process involved seamlessly integrating Excel and SQL techniques. Data processing, transformation, and preliminary analysis were conducted in Excel and subsequently further SQL analysis was conducted to further uncover key sub-surface level insights. Thorough data quality checks were performed prior to analysis, addressing inconsistencies and missing data to ensure accuracy and transparency. These included product naming inconsistencies, missing countries, required columns for analysis, and null values, all meticulously documented to maintain transparency as detailed **below**.
